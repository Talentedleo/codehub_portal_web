  ...
  <div class="wrapper  myhome"> 
   <div class="left-list"> 
    <div class="myhome-list"> 
     <ul class="home-list"> 
        <router-link to="/manager" tag="li" activeClass="active" exact><a>我的主页</a></router-link>
        <router-link to="/manager/myanswer" tag="li" activeClass="active"><a>我的回答</a></router-link>
        <router-link to="/manager/myquestion" tag="li" activeClass="active"><a>我的提问</a></router-link>
        <router-link to="/manager/myshare" tag="li" activeClass="active"><a>我的分享</a></router-link>
     </ul> 
     <ul class="home-list bottom"> 
        <router-link to="/manager/dynamic" tag="li" activeClass="active"><a>个人动态</a></router-link>
        <router-link to="/manager/myfocus" tag="li" activeClass="active"><a>我的关注</a></router-link>
        <router-link to="/manager/mycollect" tag="li" activeClass="active"><a>我的收藏</a></router-link>
        <router-link to="/manager/myreaded" tag="li" activeClass="active"><a>浏览记录</a></router-link>
        <router-link to="/manager/account" tag="li" activeClass="active" exact><a>账户设置</a></router-link>
     </ul> 
    </div> 
   </div> 

   <div class="right-content"> 
   <!-- 占位符,加载与manager.vue文件同名文件夹下index.vue的内容 -->
   <nuxt-child/>
   </div>
   <div class="clearfix"></div> 
  </div>
